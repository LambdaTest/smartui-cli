export default {
    ...
    SUPPORTED_MOBILE_DEVICES: {
        ...
        'Amazon Fire HD 10 (2021)': { os: 'android', viewport: null },
        'Amazon Fire HD 10 Plus (2021)': { os: 'android', viewport: null },
        'Amazon Fire HD 8 (2020)': { os: 'android', viewport: null },
        'Amazon Fire TV Stick': { os: 'android', viewport: null },
        'Galaxy A10s': { os: 'android', viewport: null },
        'Galaxy A11': { os: 'android', viewport: null },
        'Galaxy A13': { os: 'android', viewport: null },
        'Galaxy A52s 5G': { os: 'android', viewport: { width: 384, height: 718 } },
        'Galaxy A53 5G': { os: 'android', viewport: null },
        'Galaxy Tab A 10.1 (2019)': { os: 'android', viewport: null },
        'Galaxy Tab S9': { os: 'android', viewport: { width: 753, height: 1069 } },
        'Galaxy Z Fold4 - Folded': { os: 'android', viewport: null },
        'Galaxy Z Fold4 - Unfolded': { os: 'android', viewport: null },
        'Honor X9a 5G': { os: 'android', viewport: { width: 360, height: 678 } },
        'Huawei P30 Lite': { os: 'android', viewport: { width: 360, height: 647 } },
        'Huawei P50 Pro': { os: 'android', viewport: null },
        ...
        'iPad 10.9 (2022)': { os: 'ios', viewport: null },
        ...
        'Pixel 9 Pro': { os: 'android', viewport: null },
        'Pixel 9 Pro XL': { os: 'android', viewport: { width: 448, height: 998 } },
        'Pixel 9 Pro Fold - Unfolded': { os: 'android', viewport: null },
        'Pixel 9 Pro Fold - Folded': { os: 'android', viewport: null },
        'Realme C53': { os: 'android', viewport: null },
        'Realme Narzo 50': { os: 'android', viewport: null },
        'Realme Narzo N55': { os: 'android', viewport: null },
        'Realme 11 Pro': { os: 'android', viewport: null },
        'Redmi 9A': { os: 'android', viewport: { width: 360, height: 800 } },
        'Redmi Note 10S': { os: 'android', viewport: null },
        'Redmi Note 13 Pro': { os: 'android', viewport: { width: 412, height: 869 } },
        'Redmi Note 12 Pro': { os: 'android', viewport: null },
        'Xiaomi Mi 11 Lite': { os: 'android', viewport: null },
        'Vivo V20': { os: 'android', viewport: null },
        'Vivo V27 Pro': { os: 'android', viewport: null },
        'Vivo V20 SE': { os: 'android', viewport: null },
        'Vivo X60': { os: 'android', viewport: null },
        'Aquos Sense 5G': { os: 'android', viewport: { width: 393, height: 731 } },
        'Poco M4 Pro': { os: 'android', viewport: null },
        'Xperia 10 IV': { os: 'android', viewport: { width: 412, height: 832 } },
        'Zebra TC77': { os: 'android', viewport: null },
