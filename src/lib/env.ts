...
export default (): Env => {
    const {
        ...
        SMARTUI_PRESERVE_EXEC_LOGS_COLOR,
    ...
    return {
        ...
        LT_SDK_DEBUG_SMARTUI_CLI: LT_SDK_DEBUG_SMARTUI_CLI === 'true',
        ...
        SMARTUI_PRESERVE_EXEC_LOGS_COLOR: SMARTUI_PRESERVE_EXEC_LOGS_COLOR === 'true',
